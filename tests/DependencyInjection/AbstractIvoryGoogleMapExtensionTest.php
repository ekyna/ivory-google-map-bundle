...
namespace Ivory\Tests\GoogleMapBundle\DependencyInjection;
...
abstract class AbstractIvoryGoogleMapExtensionTest extends TestCase
{
    ...
    public function testMissingExtendableRendererClassTagAttribute()
    {
        ...
        $this->expectExceptionMessage(
            'No "class" attribute found for the tag "ivory.google_map.helper.renderer.extendable" on the service "acme.map.helper.renderer.extendable".'
        );
